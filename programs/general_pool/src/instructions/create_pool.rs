...
/// Instruction context
pub struct CreatePoolContext<'a> {
    manager: &'a AccountInfo<'a>,
    pool_market: &'a AccountInfo<'a>,
    pool_config: &'a AccountInfo<'a>,
    liquidity_mint: &'a AccountInfo<'a>,
    liquidity_account: &'a AccountInfo<'a>,
    collateral_mint: &'a AccountInfo<'a>,
    pool_market_authority: &'a AccountInfo<'a>,
    withdrawal_requests: &'a AccountInfo<'a>,
    pool: &'a AccountInfo<'a>,
    transit: &'a AccountInfo<'a>,
    rent: &'a AccountInfo<'a>,
}

impl<'a> CreatePoolContext<'a> {
    /// New instruction context
    pub fn new(
        program_id: &Pubkey,
        accounts: &'a [AccountInfo<'a>],
    ) -> Result<CreatePoolContext<'a>, ProgramError> {
