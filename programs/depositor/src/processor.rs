...
impl Processor {
    ...
    /// Process CancelRebalancing instruction
    pub fn cancel_rebalancing(program_id: &Pubkey, accounts: &[AccountInfo]) -> ProgramResult {
        let account_info_iter = &mut accounts.iter();
    ...
    pub fn process_instruction(
        ...
        match instruction {
            ...
            DepositorInstruction::CancelRebalancing => {
                msg!("DepositorInstruction: CancelRebalancing");
                Self::cancel_rebalancing(program_id, accounts)
            }
