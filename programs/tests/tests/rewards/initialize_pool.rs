...
async fn success() {
    ...
    assert_eq!(reward_pool.root_account, test_reward_pool.root_account.pubkey());
    assert_eq!(reward_pool.deposit_authority, test_reward_pool.pool.pubkey());
    assert_eq!(reward_pool.liquidity_mint, test_reward_pool.token_mint_pubkey);
}
