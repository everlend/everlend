...
pub struct MigrateRebalancingCommand;

impl<'a> ToolkitCommand<'a> for MigrateRebalancingCommand {
    fn get_name(&self) -> &'a str {
        "rebalancing"
    }

    fn get_description(&self) -> &'a str {
        "Migrate Rebalancing accounts"
    }
    ...
    fn handle(&self, config: &Config, _arg_matches: Option<&ArgMatches>) -> anyhow::Result<()> {
        ...
        println!("Migrating rebalancing accounts:");
